...
export default function UrlEditor({ url, setUrl, reqMethod, setReqMethod, onInputSend }) {
  return (
    <>
      <form className="flex">
        <select
        ...
        />
        <button
          className="ml-3 px-6 py-2 rounded-md font-semibold text-white bg-purple-500 hover:bg-purple-600"
          type="button"
